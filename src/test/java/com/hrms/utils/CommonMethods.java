...
public class CommonMethods extends BaseClass {
	...
	/**
	 * This method will take a screenshot and attach it to report
	 * 
	 * @param fileName
	 */
	public static String takeScreenshoti(String fileName) {
		TakesScreenshot ts = (TakesScreenshot) driver;
		File file = ts.getScreenshotAs(OutputType.FILE);
		String screenshotPath = Constants.SCREENSHOTS_PATH+ fileName + ".png";
		
		try {
			//FileUtils.copyFile(file, new File("screenshoti/" + fileName + ".png")); previous version
